...
```text
https://github.com/redplug/chrome-ext-kkut-shot
```
...
git branch -M main
git remote add origin https://github.com/redplug/chrome-ext-kkut-shot.git
...
```bash
https://github.com/redplug/chrome-ext-kkut-shot.git
```
...
```text
https://redplug.github.io/chrome-ext-kkut-shot/data/answers.json
```
